...
## Then: calibrate before your first session

Blind-replay an hour of professional play and measure yourself BEFORE reading
any rulebook — your defect profile will not match anyone else's. Harness and
method: github.com/chaoz23/dmcheck (README, "attention lane"). During play:

    dmcheck watch <transcript> --charter charter.json --follow --craft --pc <name>

One advisory signal at a time. It reports; you decide.
